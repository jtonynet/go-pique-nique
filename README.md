...
> #### Objetivo: `Event Driven & Hexagonal Banking Authorizer`
> 
> O `Event Driven Banking Authorizer` Simplificado é uma plataforma de pagamentos simplificada. Nela é possível depositar e realizar transferências
